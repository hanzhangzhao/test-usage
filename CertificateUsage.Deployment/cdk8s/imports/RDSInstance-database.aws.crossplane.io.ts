...
export function toJson_RdsInstanceSpec(obj: RdsInstanceSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'providerRef': toJson_RdsInstanceSpecProviderRef(obj.providerRef),
...
export interface RdsInstanceSpecProviderRef {
   ...
   * Policies for referencing.
   *
   * @schema RdsInstanceSpecProviderRef#policy
   */
  readonly policy?: RdsInstanceSpecProviderRefPolicy;

}

/**
 * Converts an object of type 'RdsInstanceSpecProviderRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RdsInstanceSpecProviderRef(obj: RdsInstanceSpecProviderRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'policy': toJson_RdsInstanceSpecProviderRefPolicy(obj.policy),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Policies for referencing.
 *
 * @schema RdsInstanceSpecProviderRefPolicy
 */
export interface RdsInstanceSpecProviderRefPolicy {
  /**
   * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
   *
   * @schema RdsInstanceSpecProviderRefPolicy#resolution
   */
  readonly resolution?: RdsInstanceSpecProviderRefPolicyResolution;

  /**
   * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
   *
   * @schema RdsInstanceSpecProviderRefPolicy#resolve
   */
  readonly resolve?: RdsInstanceSpecProviderRefPolicyResolve;

}

/**
 * Converts an object of type 'RdsInstanceSpecProviderRefPolicy' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_RdsInstanceSpecProviderRefPolicy(obj: RdsInstanceSpecProviderRefPolicy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'resolution': obj.resolution,
    'resolve': obj.resolve,
 ...
 * Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.
 *
 * @schema RdsInstanceSpecProviderRefPolicyResolution
 */
export enum RdsInstanceSpecProviderRefPolicyResolution {
  /** Required */
  REQUIRED = "Required",
  /** Optional */
  OPTIONAL = "Optional",
 ...
 * Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.
 *
 * @schema RdsInstanceSpecProviderRefPolicyResolve
 */
export enum RdsInstanceSpecProviderRefPolicyResolve {
  /** Always */
  ALWAYS = "Always",
  /** IfNotPresent */
  IF_NOT_PRESENT = "IfNotPresent",

...
export class Telemetry extends ApiObject {
  ...
  public constructor(scope: Construct, id: string, props: TelemetryProps = {}) {
    super(scope, id, Telemetry.manifest(props));
  }
}
...
export interface TelemetryProps {
  /**
   * Telemetry configuration for workloads. See more details at: https://istio.io/docs/reference/config/telemetry/telemetry.html
   *

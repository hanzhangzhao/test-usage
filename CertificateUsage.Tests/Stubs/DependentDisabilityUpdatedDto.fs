module CertificateUsage.Tests.Stubs.DependentDisabilityUpdatedDto

open System
open CertificateUsage.Dto.Events.DependentDisabilityUpdated

let dto =
    { DependentDisabilityUpdatedDto.ActiveBenefitPeriod =
        { Id = 123
          IsEnrolled = true
      ...
      Dependent = { DateOfDisability = DateTime(2023, 06, 14) }

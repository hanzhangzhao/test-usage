module CertificateUsage.Tests.Stubs.MemberDependentAddedDto
...
let dto =
    { MemberDependentAddedDto.BenefitPeriods =
        [ { Id = 123
            IsEnrolled = true
            ...
            BenefitsEndedDate = DateTime(2024, 06, 15) |> Some
            Coverages = None
            EnrollmentDate = DateTime(2023, 06, 12) |> Some } ]
      Dependent =
        { DateOfDisability = None
          Id = 123
          EligibilityPeriods =
